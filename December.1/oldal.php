...
if (isset($_POST["gomb"]) && $_POST["nev"]!=null && $_POST["pont"]!=null){
    $nev=$_POST["nev"];
    $pont=$_POST["pont"];
    $sql = "INSERT INTO jatekos VALUES ('{$nev}', $pont)";
    $stmt = $db -> exec($sql);
    if ($stmt){
        $strTable="";
...
<div class="container-fluid jumbotron border ">
    <div class="row">
                ...
                <div style="visibility:hidden;" id="eredmenyMentese">
                    Név: <input type="text" name="nev" id="nev"> <input type="text" name="pont" id="lepesSzamlaloAdo" value="" disabled><hr>
                    <input type="submit" value="Eredmany mentése" name="gomb">
                </div>
